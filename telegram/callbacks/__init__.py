...
async def new_chat_document_message(*args, crm_msg_id, **kwargs):
    await base_callback(crm_msg_id=crm_msg_id, message_type="chat", callback=__new_chat_document_message(*args, **kwargs))
...
async def new_group_document_message(*args, crm_msg_id, **kwargs):
    await base_callback(crm_msg_id=crm_msg_id, message_type="chat", callback=__new_group_document_message(*args, **kwargs))
